...
Linux users can also run SQL Server through Docker. This covers Ubuntu, Debian, Fedora, CentOS, RHEL, Rocky Linux, AlmaLinux, Arch Linux, and most distributions that support Docker.

### 3.1. Install Or Check Docker
